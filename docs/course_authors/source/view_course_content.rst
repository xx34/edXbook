...
当您在 Studio 上创建课程时，您可以控制让学生在什么时候看到您课程的内容。
这代表您可以继续建立一个课程，一直到您改变课程学生可见属性之前，学生都不能看到您所更动的内容。
您可以设定发行日期来决定何时把内容发行到网路上。您也可以特别指定一个单元的学生可见或者学生不可见。
预设情况下，所有的内容都为不可见。
...
* 不论是章的标题或是它的内容，直到发行日期之前都不会被看见。
  如果这个章的发行日期已经过了，而小节的发行日期还没过，那学生只可以在左侧的导览面板看到章标题，但是看不到小节的标题或是内容。
 
* 小节预设继承了所属章的发行日期，但是您可以在顶层的章已经发行之后，更改底下各个小节的发行日期，
...
3. 您可以设定这个包含开放内容的单元，不过 **预设情况** 下，所有单元都是学生不可见的。
...
.. note::
	...
	您在 Studio 中看您课程的方式与学生在 edX 或 Edge 上看您课程的方式不一样，因为您会看到所有的章内容，不论它们的发行时间为何时。
...
您可也看到其所属章开启评分与否；如果评分机制已开启，您可以看到小节中的作业类别。
...
不论它设定为学生可见或学生不可见状态，以及不论它的发行日期过了没，您都可以看到这些内容。
 
 
接下来的例子显示出在 Studio 查看模式 下观看 "What Does an edX Course Look Like?" 小节中两个单元的内容。
这个单元被设定为学生可见，小节的发行日期已经过了。

 
.. image:: Images/image197.png
 
 
接下来的单元被设定为学生不可见。小节的发行日期已经过了。
 
 
.. image:: Images/image199.png
 
 
如果改变 "What Does an edX Course Look Like?" 这个小节的发行日期为未来 (在这个例子中，为 January 1, 2099)，您依然可以在 Studio 看到这两个单元。
...
当您使用预览模式在 edX 或 Edge 上观看您的课程，不论他们是否设定为学生可见或学生不可见，也不管发行日期是否已经过了，您都可以看到所有在您课程中的单元，。
...
请记得小节的发行日期是过去的日期。
然而，即使您改变 "What Does an edX Course Look Like?" 小节的发行日期为未来的日期，
您依然可以在预览中看到这两个单元。
...
"What Does an edX Course Look Like?" 小节的发行日期被设定为 January 1, 2099，但是您依然可以以教师的身份在 edX 或 Edge 上看到这个单元。
...
如果您改变小节的发行日期为未来的日期 (例如 January 1, 2099) ，学生就不能看到它。
