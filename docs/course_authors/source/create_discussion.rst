...
举例来说，当您把 **分类** 设定成 “The Discussion Component”，并把 **子分类** 设定成 “Online Instruction Methods”，分类及子分类会如下出现在论坛区域中的分类清单:
...
您可以自行发表一个答案来开始这个论坛，建议最好是以匿名或以学生名义发表，如此若学生不同意您的答案，他们也能较为自由的发表自己的看法。
